...
inventory hosts file also contains a site (group) with all groups as children (see last three
...
actively, in use, playbook versions to be picked to match VNF software
release/version.
