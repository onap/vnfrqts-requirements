...
R-95303 A VNF Heat Orchestration Template must be defined using valid YAML.
...
R-25265 A VNF Heat Orchestration template must contain the section "heat_template_version:".

R-61724 A VNF Heat Orchestration Template must contain the section "description:".

R-38150 A VNF Heat Orchestration template must contain the section "paramters:".

R-37487 A VNF Heat Orchestration template must contain the section "resources:".
...
R-27078 A VNF Heat Orchestration template must contain the section "heat_template_version:".
...
R-39402 A VNF Heat Orchestration Template must contain the section "description:".
...
R-35414 A VNF Heat Orchestration template must contain the section "parameters:".
...
R-90279 All parameters declared in a VNF Heat Orchestration Template must be used in a resource with the exception of the parameters for the OS::Nova::Server resource property availability_zone.

See Section 5.4.4
for more details on availability_zone.
...
R-25877 A VNF Heat Orchestration Template parameter name must contain only alphanumeric characters and underscores ('_').
...
AA VNF Heat Orchestration Template parameter declaration may contain the attribute "label".
...
R-44001 A VNF Heat Orchestration Template parameter declaration must contain the "description" attribute.
...
R-88863 When a VNF Heat Orchestration Template parameter type is declared as a "number", a parameter constraint of  "range" or "allowed_values" must be defined.
...
R-00011 A parameter defined in a VNF Heat Orchestration Template Nested YAML file must **not** have a constraint defined.
...
R-23664 A VNF Heat Orchestration template must contain the section "resources:".

R-90152 A VNF Heat Orchestration Template section "resources:" must contain the declaration of at least one resource.
...
R-16447 A <resource ID> must be unique across all VNF Heat Orchestration Templates and all VNF HEAT Orchestration Template Nested YAML files that are used to create the VNF.
...
R-75141 A VNF Heat Orchestration Template <resource ID> must contain only alphanumeric characters and underscores ('_').
...
R-T6017 A VNF Heat Orchestration Template resource attribute "property:" must not contain nested get_param functions.
...
R-97199 A VNF Heat Orchestration Template OS::Nova::Server resource must contain the attribute metadata.
...
R-00524 A VNF Heat Orchestration template must not contain the section "conditions:".

Support for condition for resource was added in the Newton version and is not currently supported on AIC.
...
See Section 3.4 and Section 5.8 for additional details.
