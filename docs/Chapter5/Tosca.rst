...
.. req::
    ...
    The complete CSAR file **MUST** be digitally signed with the VNF/PNF provider 
    private key. The VNF/PNF provider delivers one zip file consisting of the 
    CSAR file, a signature file and a certificate file that includes the VNF/PNF 
