...
.. req::
    ...
    The VNF provider **MUST** provide an artifact per VNF that contains all
    of the VNF Event Records supported. The artifact should include reference
    to the specific release of the VNF or PNF Event Stream Common Event Data
    Model document it is based on. (e.g.,
